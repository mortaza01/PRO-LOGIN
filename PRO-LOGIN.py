...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/mortaza01/approvals/blob/main/paid.txt"])
...
def notice():
	...
	subprocess.check_output(["am", "start", "https://m.me/mortaza.nabin"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/mortaza01/approvals/blob/main/paid.txt').text
			if basesplit in plr:
				key = basesplit
...
##     ## ##     ## #### ##     ## ##     ## ##    ## 
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : MD RAIHAN KHAN 
